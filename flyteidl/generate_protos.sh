...
docker run --rm -u $(id -u):$(id -g) --rm -v $DIR:/defs $SWAGGER_CLI_IMAGE generate -i /defs/gen/pb-go/flyteidl/service/admin.swagger.json -l typescript-fetch -DsupportsES6=true --additional-properties=packageName=flyteadmin --model-name-prefix='' -o /defs/gen/pb-js/flyteidl/service/flyteadmin

# # Generate Javascript API client code
docker run --rm -u $(id -u):$(id -g) --rm -v $DIR:/defs $SWAGGER_CLI_IMAGE generate -i /defs/gen/pb-go/flyteidl/service/admin.swagger.json -l typescript-node -DsupportsES6=true --additional-properties=packageName=flyteadmin --model-name-prefix='' -o /defs/gen/pb-node/flyteidl/service/flyteadmin
