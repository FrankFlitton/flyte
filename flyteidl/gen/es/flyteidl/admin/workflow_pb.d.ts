...
import type { WorkflowTemplate } from "../core/workflow_pb.js";
 ...
 */
export declare class WorkflowCreateRequest extends Message<WorkflowCreateRequest> {
  /**
 ...
 */
export declare class WorkflowCreateResponse extends Message<WorkflowCreateResponse> {
 ...
 */
export declare class WorkflowList extends Message<WorkflowList> {
  /**
 ...
 */
export declare class WorkflowSpec extends Message<WorkflowSpec> {
  /**
 ...
 */
export declare class WorkflowErrorExistsDifferentStructure extends Message<WorkflowErrorExistsDifferentStructure> {
  /**
   * @generated from field: flyteidl.core.Identifier id = 1;
   */
  id?: Identifier;
 ...
 */
export declare class WorkflowErrorExistsIdenticalStructure extends Message<WorkflowErrorExistsIdenticalStructure> {
  /**
   * @generated from field: flyteidl.core.Identifier id = 1;
   */
  id?: Identifier;
 ...
 */
export declare class CreateWorkflowFailureReason extends Message<CreateWorkflowFailureReason> {
  /**
