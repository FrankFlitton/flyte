...
import type { KeyValuePair, RetryStrategy } from "./literals_pb.js";
import type { Identifier } from "./identifier_pb.js";
import type { TypedInterface } from "./interface_pb.js";
import type { SecurityContext } from "./security_pb.js";
 ...
 */
export declare enum Resources_ResourceName {
  /**
 ...
 */
export declare class Resources_ResourceEntry extends Message<Resources_ResourceEntry> {
  /**
   * Resource name.
   *
 ...
 */
export declare class GPUAccelerator extends Message<GPUAccelerator> {
  /**
 ...
 */
export declare class ExtendedResources extends Message<ExtendedResources> {
  /**
 ...
 */
export declare class RuntimeMetadata extends Message<RuntimeMetadata> {
  /**
   * Type of runtime.
   *
 ...
 */
export declare enum RuntimeMetadata_RuntimeType {
  /**
 ...
 */
export declare class TaskMetadata extends Message<TaskMetadata> {
  /**
 ...
 */
export declare class TaskTemplate extends Message<TaskTemplate> {
  /**
 ...
 */
export declare enum Container_Architecture {
  /**
   * @generated from enum value: UNKNOWN = 0;
   */
  UNKNOWN = 0,
 ...
 */
export declare class IOStrategy extends Message<IOStrategy> {
  /**
 ...
 */
export declare enum IOStrategy_DownloadMode {
  /**
 ...
 */
export declare enum IOStrategy_UploadMode {
  /**
 ...
 */
export declare class DataLoadingConfig extends Message<DataLoadingConfig> {
  /**
 ...
 */
export declare enum DataLoadingConfig_LiteralMapFormat {
  /**
 ...
 */
export declare class K8sPod extends Message<K8sPod> {
  /**
 ...
 */
export declare class K8sObjectMetadata extends Message<K8sObjectMetadata> {
  /**
 ...
 */
export declare class Sql extends Message<Sql> {
  /**
 ...
 */
export declare enum Sql_Dialect {
  /**
